...
# for all the OG with species_num > 6
# in these OGs, paralog exist
conservation_score <- read_csv("data/conservation_score_sce_based_on_original_protein_align_15461.csv")
