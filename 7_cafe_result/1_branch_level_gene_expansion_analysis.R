...
gene_expand_non_WGD$pathway <- getSingleReactionFormula(KO_pathway0$V2.y,KO_pathway0$V2.x, gene_expand_non_WGD$KO)
...
gene_expand_WGD$pathway <- getSingleReactionFormula(KO_pathway0$V2.y,KO_pathway0$V2.x, gene_expand_WGD$KO)
